...
class ControllerCoach extends Controller
{
    ...
    public function displayAvailableCoachs()
    {
        ...
        $managerCoach = new CoachDao($this->getPdo()); // Utilisation du modèle CoachDao
        $coachs = $managerCoach->findAvailableCoachs(); // Trouver les coachs disponibles
        ...
        echo $template->render([
            ...
            'coachs' => $coachs,    // Liste des coachs avec leurs séances et notes
        ]);
    }
}
